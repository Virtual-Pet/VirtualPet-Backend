package com.virtualpet.backend.cart.service;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.virtualpet.backend.cart.domain.Cart;
import com.virtualpet.backend.cart.domain.CartItem;
import com.virtualpet.backend.cart.dto.CartDTO.AddItemRequest;
import com.virtualpet.backend.cart.dto.CartDTO.CartItemResponse;
import com.virtualpet.backend.cart.dto.CartDTO.CartResponse;
import com.virtualpet.backend.cart.dto.CartDTO.UpdateItemRequest;
...
public class CartService {
    ...
    private Cart loadCart(String sessionId) {
        ...
        try {
            ...
            log.warn(
                    "Failed to deserialize cart for sessionId={}, returning empty cart",
                    sessionId,
                    e);
            return Cart.builder().build();
        }
