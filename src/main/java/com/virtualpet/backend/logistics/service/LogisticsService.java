package com.virtualpet.backend.logistics.service;
...
import com.virtualpet.backend.logistics.dto.LogisticsDTO.PendingOrderResponse;
import com.virtualpet.backend.logistics.dto.LogisticsDTO.ShipmentStatusResponse;
import com.virtualpet.backend.logistics.repository.ShipmentRepository;
                        ...
                        .orElseThrow(
                                () ->
                                        new ApiException(
                                                ...
                                                "Envío no encontrado para orderId=" + orderId));
    ...
    private void validateTransition(ShipmentStatus current, ShipmentStatus next) {
        ...
        if (!valid) {
            throw new ApiException(
                    HttpStatus.CONFLICT, "Transición inválida: " + current + " → " + next);
        }
    }
}
