 ...
 *
 * <p>Default implementation is {@link NoOpStorageService}. Replace with an S3-backed
 * implementation (e.g. {@code S3StorageService}) when AWS credentials are available.
 */
