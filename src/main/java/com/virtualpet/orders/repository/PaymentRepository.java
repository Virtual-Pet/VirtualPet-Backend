...
public interface PaymentRepository extends JpaRepository<PaymentEntity, UUID> {
  ...
  /**
   * Returns the most recent payment for a session. Handles edge-cases where multiple payment
   * intents were created for the same session (e.g. user retried checkout).
   */
